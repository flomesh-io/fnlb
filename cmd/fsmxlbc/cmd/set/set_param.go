...
func NewSetLogLevelCmd(restOptions *xlbcli.RESTOptions) *cobra.Command {
...
func ReadSetLogLevelOptions(o *xlbcli.ParamDump, args []string) error {
	if len(args) > 1 {
...
func ParamAPICall(restOptions *xlbcli.RESTOptions, parmaModel xlbcli.ParamDump) (*http.Response, error) {
