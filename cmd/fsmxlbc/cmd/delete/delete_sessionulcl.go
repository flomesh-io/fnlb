...
func NewDeleteSessionUlClCmd(restOptions *xlbcli.RESTOptions) *cobra.Command {
	o := DeleteSessionUlClOptions{}

	var deleteLbCmd = &cobra.Command{
		Use:     "sessionulcl <UserID> --ulclArgs=<UlCLIP>,...",
		Short:   "Delete a Ulcl configuration in the fsmxlb.",
		Long:    `Delete a Ulcl configuration in the fsmxlb.`,
