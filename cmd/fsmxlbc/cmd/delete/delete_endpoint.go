...
func NewDeleteEndPointCmd(restOptions *xlbcli.RESTOptions) *cobra.Command {
	o := DeleteEndPoint{}
	...
	var deleteEndPointCmd = &cobra.Command{
		...
		Long: `Delete a LB EndPoint from monitoring in the fsmxlb.

ex) fsmxlbc delete endpoint 31.31.31.31 --name=31.31.31.31_http_8080 --probetype=http --probeport=8080"
		`,
