...
func NewDeleteFirewallCmd(restOptions *xlbcli.RESTOptions) *cobra.Command {
	...
	var deleteFirewallCmd = &cobra.Command{
		...
		Long: `Delete a Firewall using ruleKey in the fsmxlb.
...
ex) fsmxlbc delete firewall --firewallRule="sourceIP:1.2.3.2/32,destinationIP:2.3.1.2/32,preference:200"
		`,
