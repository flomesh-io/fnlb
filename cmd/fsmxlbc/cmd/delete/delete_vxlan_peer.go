...
func NewDeleteVxlanPeerCmd(restOptions *xlbcli.RESTOptions) *cobra.Command {
	var deleteVxlanPeerCmd = &cobra.Command{
		Use:   "vxlanpeer <Vnid> <PeerIP> ",
		Short: "Delete a vxlanPeer",
		Long: `Delete a vxlanPeer using Vnid in the fsmxlb.
ex) fsmxlbc delete vxlan-peer 100 30.1.3.1
