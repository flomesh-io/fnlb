...
func ApplyCmd(options *ApplyOptions, restOptions *xlbcli.RESTOptions) *cobra.Command {
...
func ApplyLbConfig(file string, restOptions *xlbcli.RESTOptions) {
	// open file
	var lbresp xlbcli.LbRuleModGet
	...
	for _, lb := range lbresp.LbRules {
		...
		for _, ep := range lb.Endpoints {
			endPoint := xlbcli.LoadBalancerEndpoint{
...
func ApplySessionConfig(file string, restOptions *xlbcli.RESTOptions) {
	// open file
	var resp xlbcli.SessionInformationGet
	byteBuf, err := os.ReadFile(file)
	if err != nil {
		fmt.Println(err.Error())
		return
...
func ApplySessionUlClConfig(file string, restOptions *xlbcli.RESTOptions) {
	// open file
	var resp xlbcli.UlclInformationGet
	byteBuf, err := os.ReadFile(file)
	if err != nil {
		fmt.Println(err.Error())
		return
...
func ApplyFWConfig(file string, restOptions *xlbcli.RESTOptions) {
	// open file
	var resp xlbcli.FWInformationGet
	byteBuf, err := os.ReadFile(file)
	if err != nil {
		fmt.Println(err.Error())
		return
