...
func NewGetConntrackCmd(restOptions *xlbcli.RESTOptions) *cobra.Command {
...
func PrintGetCTResult(resp *http.Response, o xlbcli.RESTOptions) {
	ctresp := xlbcli.CtInformationGet{}
	var data [][]string
...
func makeConntrackData(ctresp xlbcli.CtInformationGet) (data [][]string) {
