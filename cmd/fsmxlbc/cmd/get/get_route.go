...
func NewGetRouteCmd(restOptions *xlbcli.RESTOptions) *cobra.Command {
	var GetrouteCmd = &cobra.Command{
		Use:   "route",
		Short: "Get a route",
		Long:  `It shows route Information in the xlbroute`,
...
func PrintGetRouteResult(resp *http.Response, o xlbcli.RESTOptions) {
	routeresp := xlbcli.RouteModGet{}
	var data [][]string
