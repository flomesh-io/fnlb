...
func NewGetVlanCmd(restOptions *xlbcli.RESTOptions) *cobra.Command {
	var GetVlanCmd = &cobra.Command{
		Use:   "vlan",
		Short: "Get a Vlan",
		Long:  `It shows Vlan Information in the fsmxlb`,
...
func PrintGetVlanResult(resp *http.Response, o xlbcli.RESTOptions) {
	Vlanresp := xlbcli.VlanGet{}
	var data [][]string
...
func MemberToString(members []xlbcli.VlanMemberMod) (ret string) {
...
func VlanStatToString(stat xlbcli.VlanStat) (ret string) {
