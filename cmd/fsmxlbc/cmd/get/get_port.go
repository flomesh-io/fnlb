...
func NewGetPortCmd(restOptions *xlbcli.RESTOptions) *cobra.Command {
...
func PrintGetPortResult(resp *http.Response, o xlbcli.RESTOptions) {
	portresp := xlbcli.PortGet{}
	var data [][]string
...
func MakeL3InfoRoString(l3 xlbcli.PortLayer3Info) (ret string) {
	ret = fmt.Sprintf("Routed: %v\nIPv4 : %s \nIPv6 : %s", l3.Routed, l3.Ipv4_addrs, l3.Ipv6_addrs)
	return ret
}
func MakeL2InfoRoString(l2 xlbcli.PortLayer2Info) (ret string) {
