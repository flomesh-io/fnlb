...
func NewGetNeighborCmd(restOptions *xlbcli.RESTOptions) *cobra.Command {
	var GetNeighborCmd = &cobra.Command{
		Use:     "neighbor",
		Short:   "Get a neighbors",
		Long:    `It shows neighbors Information in the fsmxlb`,
...
func PrintGetNeighborResult(resp *http.Response, o xlbcli.RESTOptions) {
	Neighborsresp := xlbcli.NeighborModGet{}
	var data [][]string
