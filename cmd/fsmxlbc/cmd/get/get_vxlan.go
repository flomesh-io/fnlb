...
func NewGetVxlanCmd(restOptions *xlbcli.RESTOptions) *cobra.Command {
	var GetvxlanCmd = &cobra.Command{
		Use:   "vxlan",
		Short: "Get a vxlan",
		Long:  `It shows vxlan Information in the fsmxlb`,
...
func PrintGetvxlanResult(resp *http.Response, o xlbcli.RESTOptions) {
	vxlanresp := xlbcli.VxlanGet{}
	var data [][]string
