...
func NewGetIPAddressCmd(restOptions *xlbcli.RESTOptions) *cobra.Command {
	var GetIPAddressCmd = &cobra.Command{
		Use:     "ip",
		Short:   "Get a IP Address",
		Long:    `It shows IP Address Information in the fsmxlb`,
...
func PrintGetIPAddressResult(resp *http.Response, o xlbcli.RESTOptions) {
	IPv4Addressresp := xlbcli.Ipv4AddrModGet{}
	var data [][]string
