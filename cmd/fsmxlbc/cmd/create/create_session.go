...
func NewCreateSessionCmd(restOptions *xlbcli.RESTOptions) *cobra.Command {
	...
	var createSessionCmd = &cobra.Command{
		...
		Long: `Create a Session using fsmxlb
		
ex) fsmxlbc create session user1 192.168.20.1 --accessNetworkTunnel=1:1.232.16.1 --coreNetworkTunnel=1:1.233.16.1
		...
		Run: func(cmd *cobra.Command, args []string) {
			var SessionMod xlbcli.SessionMod
			// Make SessionMod
...
func ReadCreateSessionOptions(o *xlbcli.SessionMod, args []string) error {
	if len(args) > 3 {
...
func GetNetworkTunnelPairList(o *xlbcli.SessionMod, networkTunnel string, An bool) error {
...
func SessionAPICall(restOptions *xlbcli.RESTOptions, sessionModel xlbcli.SessionMod) (*http.Response, error) {
