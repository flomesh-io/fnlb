...
func NewCreateFirewallCmd(restOptions *xlbcli.RESTOptions) *cobra.Command {
	...
	var createFirewallCmd = &cobra.Command{
		...
		Long: `Create a Firewall using fsmxlb
...
ex) fsmxlbc create firewall --firewallRule="sourceIP:1.2.3.2/32,destinationIP:2.3.1.2/32,preference:200" --allow
    fsmxlbc create firewall --firewallRule="sourceIP:1.2.3.2/32,destinationIP:2.3.1.2/32,preference:200" --allow --record
	fsmxlbc create firewall --firewallRule="sourceIP:1.2.3.2/32,destinationIP:2.3.1.2/32,preference:200" --allow --setmark=10
    fsmxlbc create firewall --firewallRule="sourceIP:1.2.3.2/32,destinationIP:2.3.1.2/32,preference:200" --drop
	fsmxlbc create firewall --firewallRule="sourceIP:1.2.3.2/32,destinationIP:2.3.1.2/32,preference:200" --trap
	fsmxlbc create firewall --firewallRule="sourceIP:1.2.3.2/32,destinationIP:2.3.1.2/32,preference:200" --redirect=hs1
`,
		...
		Run: func(cmd *cobra.Command, args []string) {
			var FirewallMods xlbcli.FwRuleMod
			// Make FirewallMod
...
func GetFirewallRulePairList(o *xlbcli.FwRuleMod, FWrule []string) error {
...
func GetFWOptionPairList(FirewallMods *xlbcli.FwRuleMod, o CreateFirewallOptions) error {
...
func FirewallAPICall(restOptions *xlbcli.RESTOptions, FirewallModel xlbcli.FwRuleMod) (*http.Response, error) {
