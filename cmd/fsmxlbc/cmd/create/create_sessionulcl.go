...
func NewCreateSessionUlClCmd(restOptions *xlbcli.RESTOptions) *cobra.Command {
	...
	var createSessionCmd = &cobra.Command{
		...
		Long: `Create a Session UlCl using fsmxlb

ex) fsmxlbc create sessionulcl user1 --ulclArgs=16:192.33.125.1
		`,
		...
		Run: func(cmd *cobra.Command, args []string) {
			var SessionMods xlbcli.UlclInformationGet
			// Make SessionMod
...
func ReadCreateSessionUlClOptions(o *xlbcli.UlclInformationGet, args []string, numUlclArgs int) error {
	if len(args) > 2 {
	...
	for i := 0; i < numUlclArgs; i++ {
		t := xlbcli.SessionUlClMod{Ident: args[0]}
...
func GetUlClArgsPairList(o *xlbcli.UlclInformationGet, ulclArgs []string) error {
...
func SessionUlClAPICall(restOptions *xlbcli.RESTOptions, ulclModel xlbcli.SessionUlClMod) (*http.Response, error) {
