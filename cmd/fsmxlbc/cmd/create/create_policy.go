...
func GetRatePair(body *xlbcli.PolMod, RateBlock string) error {
...
func GetBlockPair(body *xlbcli.PolMod, Block string) error {
...
func GetTargetPair(body *xlbcli.PolMod, Block string) error {
	BlockPair := strings.Split(Block, ":")
	if len(BlockPair) != 2 {
		return errors.New("error")
	}
	...
	body.Target.AttachMent = xlbcli.PolObjType(AttachMent)
	return nil
}

func NewCreatePolicyCmd(restOptions *xlbcli.RESTOptions) *cobra.Command {
...
Ex) fsmxlbc create policy pol-hs0 --rate=100:100 --target=hs0:1
    fsmxlbc create policy pol-hs1 --rate=100:100 --target=hs0:1 --block-size=12000:6000
    fsmxlbc create policy pol-hs1 --rate=100:100 --target=hs0:1 --color
    fsmxlbc create policy pol-hs1 --rate=100:100 --target=hs0:1 --color --pol-type 0
...
func PrintCreatePolResult(resp *http.Response, o xlbcli.RESTOptions) {
...
func PolicyAPICall(restOptions *xlbcli.RESTOptions, PolModel xlbcli.PolMod) (*http.Response, error) {
