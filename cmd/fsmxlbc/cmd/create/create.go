...
func CreateCmd(restOptions *xlbcli.RESTOptions) *cobra.Command {
	var createCmd = &cobra.Command{
		Use:   "create",
		Short: "Create a Load balance features in the fsmxlb.",
		Long: `Create a Load balance features in the fsmxlb.
