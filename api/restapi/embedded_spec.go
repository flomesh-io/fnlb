...
func init() {
  ...
  "swagger": "2.0",
  "info": {
    "description": "Fsmxlb REST API for Baremetal Scenarios",
    "title": "Fsmxlb Rest API",
    "version": "0.0.1"
  },
  "host": "0.0.0.0:11111",
  "basePath": "/flomesh/v1",
  "paths": {
    ...
    "/config/endpoint/all": {
      "get": {
        "description": "Get End-Points State in fsmxlb",
        "summary": "Get End-Points State in fsmxlb",
        "responses": {
          "200": {
            "description": "OK",
            "schema": {
    ...
    "/config/params": {
      "get": {
        "description": "Get Operational params of Fsmxlb",
        "summary": "Get Operational params of Fsmxlb",
        "responses": {
          "200": {
            "description": "OK",
            "schema": {
      ...
      "post": {
        "description": "Set Operational parameters of Fsmxlb",
        "summary": "Set Operational parameters of Fsmxlb",
        "parameters": [
          {
    ...
    "/config/vlan/{vlan_id}/member/{if_name}/tagged/{tagged}": {
      "delete": {
        "description": "Remove a vlan member from a vlan interface which is defined by vlan_id. If the Vlan interface does not exist on Fsmxlb OR a vlan member 'if_name' is not present on the interface the API will return '404'. If the vlan_id passed is less than 2 or greater than 4094 the API will respond with error '400'.",
