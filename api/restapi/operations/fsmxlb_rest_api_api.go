...
// NewFsmxlbRestAPIAPI creates a new FsmxlbRestAPI instance
func NewFsmxlbRestAPIAPI(spec *loads.Document) *FsmxlbRestAPIAPI {
	return &FsmxlbRestAPIAPI{
...
/*FsmxlbRestAPIAPI Fsmxlb REST API for Baremetal Scenarios */
type FsmxlbRestAPIAPI struct {
	spec            *loads.Document
...
func (o *FsmxlbRestAPIAPI) UseRedoc() {
	o.useSwaggerUI = false
}

// UseSwaggerUI for documentation at /docs
func (o *FsmxlbRestAPIAPI) UseSwaggerUI() {
	o.useSwaggerUI = true
}

// SetDefaultProduces sets the default produces media type
func (o *FsmxlbRestAPIAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *FsmxlbRestAPIAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *FsmxlbRestAPIAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *FsmxlbRestAPIAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *FsmxlbRestAPIAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *FsmxlbRestAPIAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *FsmxlbRestAPIAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the FsmxlbRestAPIAPI
func (o *FsmxlbRestAPIAPI) Validate() error {
...
func (o *FsmxlbRestAPIAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *FsmxlbRestAPIAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
	return nil
}

// Authorizer returns the registered authorizer
func (o *FsmxlbRestAPIAPI) Authorizer() runtime.Authorizer {
	return nil
}

// ConsumersFor gets the consumers for the specified media types.
// MIME type parameters are ignored here.
func (o *FsmxlbRestAPIAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
// MIME type parameters are ignored here.
func (o *FsmxlbRestAPIAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *FsmxlbRestAPIAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the fsmxlb rest API API
func (o *FsmxlbRestAPIAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *FsmxlbRestAPIAPI) initHandlerCache() {
...
func (o *FsmxlbRestAPIAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *FsmxlbRestAPIAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *FsmxlbRestAPIAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
	o.customProducers[mediaType] = producer
}

// AddMiddlewareFor adds a http middleware to existing handler
func (o *FsmxlbRestAPIAPI) AddMiddlewareFor(method, path string, builder middleware.Builder) {
	um := strings.ToUpper(method)
	if path == "/" {
		path = ""
	}
