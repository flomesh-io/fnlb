...
#define LLB_MGMT_CHANNEL      "flb0"
#define LLB_SECTION_PASS      "xdp_pass"
#define LLB_FP_IMG_DEFAULT    "/opt/fsmxlb/llb_xdp_main.o"
#define LLB_FP_IMG_BPF        "/opt/fsmxlb/llb_ebpf_main.o"
#define LLB_DB_MAP_PDIR       "/opt/fsmxlb/dp/bpf"
