...
#include <net/if.h>
#include <pthread.h>
#include "../../bpf/kernel/xlb_libdp.h"
int bpf_map_get_next_key(int fd, const void *key, void *next_key);
int bpf_map_lookup_elem(int fd, const void *key, void *value);
extern void goMapNotiHandler(struct ll_dp_map_notif *);
#cgo CFLAGS:  -I./../../bpf/libbpf/src/ -I./../../bpf/common
#cgo LDFLAGS: -L. -L/lib64 -L./../../bpf/kernel -L./../../bpf/libbpf/src/build/usr/lib64/ -Wl,-rpath=/lib64/ -lloxilbdp -lbpf -lelf -lz
*/
import "C"
import (
	"errors"
...
// The implementation is specific to ebpf datapath for linux
...
// unLoadEbpfPgm - unload eBPF program from an interface
...
func dpCTMapNotifierWorker(cti *DpCtInfo) {
	...
	if addOp == false {
		...
		if ret == 0 {
			...
			// This is a strange fix - Sometimes fsmxlb runs as multiple docker
