...
// PortAdd - add a port to xlbnet realm
...
// PortDel - delete a port from xlbnet realm
...
// Ports2Json - dump ports in xlbnet realm to json format
...
// PortsToGet - dump ports in xlbnet realm to api format
...
// Ports2String - dump ports in xlbnet realm to string format
...
// PortFindByName - find a port in xlbnet realm given port name
func (P *PortsH) PortFindByName(name string) (p *Port) {
	p, _ = P.portSmap[name]
	return p
}

// PortFindByOSID - find a port in xlbnet realm given os identifier
...
// PortDestructAll - destroy all ports in xlbnet realm
...
// DP - sync state of port entities in xlbnet realm to data-path
