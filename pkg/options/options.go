...
var Opts struct {
	...
	Version           bool           `short:"v" long:"version" description:"Show fsmxlb version"`
	...
	TLSCertificate    flags.Filename `long:"tls-certificate" description:"the certificate to use for secure connections" default:"/opt/fsmxlb/cert/server.crt" env:"TLS_CERTIFICATE"`
	TLSCertificateKey flags.Filename `long:"tls-key" description:"the private key to use for secure connections" default:"/opt/fsmxlb/cert/server.key" env:"TLS_PRIVATE_KEY"`
